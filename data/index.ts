  ...
  export const gridItems = [
    {
      ...
      description: "",
      className: "lg:col-span-3 md:col-span-6 md:row-span-4 lg:min-h-[60vh] grid-scrolltrigger",
  ...
  export const projects = [
    {
      ...
      des: "I leveraged the power of React and the flexibility of SCSS to develop a website for a real estate agency called Kasa.",
      img: "/kasa.jpg",
      iconLists: ["/re.svg","/sass.svg"],
      link: 'https://kasa-home-website.netlify.app/',
    },
    {
      id: 2,
    ...
    {
      id: 4,
      title: "Brik à Brok - Digital agency (in progress)",
      des: "Actually building a digital agency's website on react, animated with GSAP.",
      img: "/bab.PNG",
