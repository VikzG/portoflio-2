...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "row-span-1 relative overflow-hidden rounded-2xl group/bento hover:shadow-xl shadow-input dark:shadow-none border justify-between flex flex-col space-y-4 border-white/[0.1]",
        className
      )}
      style={{
